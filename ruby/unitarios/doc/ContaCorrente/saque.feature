...
Cenário: Saque em conta corrente
    ...
    Quando faço um saque de R$ 200 reais com uma taxa de 5 reais
    Então meu saldo final deve ser R$ 795
...
Cenário: Tenho saldo mas não o suficiente
    ...
    Dado que eu tenho R$ 500 reais em minha conta corrente
...
Cenário: Limite por saque :(
    ...
    Dado que eu tenho R$ 1000 reais em minha conta corrente
